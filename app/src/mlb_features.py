...
N_MLB_FEATURES = len(MLB_FEATURES)   # 24 after adding trend_diff
...
def _assemble(
    ...
    return np.array([
        ...
        # ── Starting pitcher ──────────────────────────────────────────────────
        away_sp["era"]    - home_sp["era"],         # 10 sp_era_diff   (pos = home better)
        ...
        # ── Bullpen ───────────────────────────────────────────────────────────
        away_bp["era"]     - home_bp["era"],        # 19 bullpen_era_diff
